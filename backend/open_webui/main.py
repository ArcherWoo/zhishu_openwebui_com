...
app.state.config.ENABLE_UPLOAD_DECRYPTION = ENABLE_UPLOAD_DECRYPTION
app.state.config.DECRYPT_SERVER_URL = DECRYPT_SERVER_URL
app.state.config.DECRYPT_TIMEOUT_SECONDS = DECRYPT_TIMEOUT_SECONDS
app.state.config.DECRYPT_OUTPUT_DIR = DECRYPT_OUTPUT_DIR
